...
public class DriverManager {
    ...
    /*
    olusturdugumuz obje uzerinde setPlatform, setBrowserName ve setVersion yapıyorum.
     */
    ...
    public WebDriver setUpChromeDriver() {
        ...
        ChromeOptions chromeOptions = new ChromeOptions(); // grid options'lar ile calisir.
        chromeOptions.merge(capabilities); // setPlatform, setBrowserName, setVersion her biri ayri ayri feature'lar
        // bu ucunu drıver'a yuklemek icin bu ucunu birbirine baglamam lazim. bunu yapan merge'dur.
